...
import com.idata.aibox.business.WebsocketService;
...
//        Intent intent=new Intent(MainActivity.this,)
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bt_send:
                OsModule.getOsOperator().sendLockStatus2Server(false);
                break;
        }
    }

    private void connectAndStartService() {
        MyLog.d("activity start service!is service running:" + WebsocketService.isServiceRunning("com.idata.aibox.business.WebsocketService", this));
