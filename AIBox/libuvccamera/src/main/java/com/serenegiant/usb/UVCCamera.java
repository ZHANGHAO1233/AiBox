...
public class UVCCamera {
	...
	public static final int DEFAULT_PREVIEW_WIDTH = 1280;//1280
	public static final int DEFAULT_PREVIEW_HEIGHT = 960;//960
...
//    		mNativePtr = 0;	// nativeDestroyを呼ぶのでここでクリアしちゃダメ
	...
	public synchronized String getSupportedSize() {
		Log.d(TAG,"***************** zhuqiang getSupportedSize = "+mSupportedSize);
