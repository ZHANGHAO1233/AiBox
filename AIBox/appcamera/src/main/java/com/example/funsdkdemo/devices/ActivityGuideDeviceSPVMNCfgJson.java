...
import static com.idata.aibox.R.id.img_setup_motion_move_btn;
import static com.idata.aibox.R.id.img_setup_outalarm_open_btn;
import static com.idata.aibox.R.id.img_setup_screen_occlusion_btn;
import static com.idata.aibox.R.id.img_setup_server_open_btn;
import static com.idata.aibox.R.id.img_setup_system_abnormality_btn;
import static com.idata.aibox.R.id.img_setup_user_connect_btn;
import static com.idata.aibox.R.id.img_setup_video_dismiss_btn;
...
public class ActivityGuideDeviceSPVMNCfgJson extends ActivityDemo implements View.OnClickListener, IFunSDKResult {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		FunSDK.DevGetConfigByJson(mHandler, mFunDevice.devSn,
                SPVMNCfgJson.CONFIG_NAME, 4096, -1, 10000, mFunDevice.getId());
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.backBtnInTopLayout:
				...
				break;
			case img_setup_server_open_btn: {
	...
	private void trySaveConfig() {
		...
		FunSDK.DevSetConfigByJson(mHandler, mFunDevice.getDevSn(), SPVMNCfgJson.CONFIG_NAME, CfgJson.getSendMsg(), -1, 60000, mFunDevice.getId());
	}
